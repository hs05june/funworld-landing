...
const TicketsPage = () => {
  ...
  return (
    <div className="min-h-screen w-screen flex flex-col select-none	">
      ...
      {page == 1 ? (
        <div className="flex flex-col gap-8 lg:mt-20 3xl:mt-80  2xl:mt-60 xl:mt-40">
          <section className="flex items-center justify-center ">
            <div className="md:w-[60vw] w-[80vw] min-h-[180px] bg-[#FFEEF6] rounded-2xl flex flex-col md:flex-row justify-around items-center gap-4 py-4">
              <div
                ...
                className={`w-[220px] md:h-[130px] h-[80px] bg-[#0B1A48] text-white text-xs font-bold md:text-xl shadow-xl hover:scale-105 transition-all rounded-xl ease cursor-pointer flex flex-col gap-4 md:p-6 md:pt-8 pt-3 items-center text-center ${
              ...
              >
                <label
                  className={`w-[220px] md:h-[130px] h-[80px] p-1 text-xs font-bold rounded-xl shadow-xl bg-[#0B1A48] text-white  hover:scale-105 transition-all ease cursor-pointer flex flex-col gap-4 md:p-6 md:pt-8 pt-3 items-center text-center  ${
