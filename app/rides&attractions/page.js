...
import rides14 from "@/public/Amusement/roller.webp";
...
const ridesArray = [
  ...
  { img: rides2, text: "Fun Express" },
  { img: rides3, text: "Cycle  Monorail" },
  { img: rides4, text: "Techno Jump" },
  { img: rides5, text: "Shark Ride" },
  { img: rides6, text: "Mini Train" },
  { img: rides7, text: "Flying Appu" },
  { img: rides8, text: "Kiddy Swing Chair" },
  { img: rides9, text: "Carousel" },
  { img: rides10, text: "Matter Horn" },
    { img: rides12, text: "Power Surge" },
    { img: rides13, text: "Tsunami" },
    { img: rides14, text: "Roller Coaster" },
    { img: rides15, text: "Pendulum" },
    { img: rides16, text: "High Tower" },
    { img: rides17, text: "Sky Drop" },
    { img: rides18, text: "Wind Mill" },
    { img: rides19, text: "Kiddy Tagada" },
    { img: rides20, text: "Motor Bike" },
    { img: rides21, text: "Helecoptor" },
    { img: rides22, text: "Revolving Tower" },
    { img: rides23, text: "Mini Pirate Ship " },
    { img: rides24, text: "Children Jeep" },
    { img: rides25, text: "NFS Car" },
    { img: rides26, text: "Flying Tiger" },
  ...
  return (
    <div className='w-screen flex flex-col  '>
      <section className='w-full min-h-[629px] relative max-lg:min-h-[400px] max-xl:min-h-[450px] xl:h-fit max-md:min-h-[300px] max-sm:min-h-[250px]'>
        <Image className='bg-cover bg-center bg-no-repeat absolute top-0 -z-10  max-sm:h-full object-contain  max-xs:object-cover ' src={"/Rides&Attractions/hero_background.webp"} alt="bacgkround img" width={2042} height={1029} />
