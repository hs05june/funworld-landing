  ...
  const ridesArray = [
    {
      ...
      rideNotFor: "This is another dummy text",
    },
    {
      img: "https://funworldblr.s3.amazonaws.com/public/Amusement/rides2.jpeg",
      text: "ride 2",
        ...
        <div className="px-[13vw] flex flex-col gap-8 text-[#5B5B5B] max-lg:px-[7vw] ">
          <div className="flex max-md:flex-col">
            <div className="w-[50%] max-md:w-full">
              <Image
                src={
                  "https://funworldblr.s3.amazonaws.com/public/ride_page/main.jpg"
                }
                width={672}
                height={200}
                alt="/"
              ...
              <p className="mt-10 text-lg">
                Wonderla introduces India’s first-ever reverse looping Roller
                Coaster - RECOIL, which will give you a whole new experience of
                thrill. This high tech roller coaster is imported from the
                Netherlands and has two track ramps that go up to 40 meters. The
                train climbs one ramp and accelerates to 80 kmph in 1 second,
                before encountering a ‘cobra roll’ and a ‘loop’ in the tracks,
                climbing the second ramp, again to a 40 m height, and then doing
