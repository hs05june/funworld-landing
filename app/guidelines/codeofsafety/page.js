...
export const metadata = {
  title: "Code of Safety",
  description:
    "Funworld Bangalore: Code of Safety: Ensuring your fun day out with strict safety measures. Enjoy worry-free adventures and unforgettable memories.",
};

const CodeOfSafetyTextPage = () => {
  return (
    <>
      <Head>
...
export default CodeOfSafetyTextPage;
