...
export const metadata = {
  title: "Disabled Guests",
  description:
    "Funworld Bangalore: Accessibility for Disabled Guests: We ensure everyone can enjoy the fun. Learn about our accessible facilities and services.",
};
