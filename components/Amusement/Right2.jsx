    ...
    return (
        <div className='h-full w-full flex my-16 '>
                    ...
                    <div className='my-6'>
                        <Link href="/kidsrides">
                            <button className='flex items-center btn text-white px-8 py-2'>
                                Know More <span className='bg-white rounded-[50%] w-10 h-10 ml-5 flex items-center justify-center '><Image src="/arrow.webp" priority height={18} width={18} alt="abc" /></span>
                            </button>
                        </Link>
            ...
            <div className='h-full  w-[48%]  flex '>
                <Image priority src={image} className=" w-full h-full  object-cover" loading='lazy' alt="abc" />
            </div>
        </div>
    )
}
