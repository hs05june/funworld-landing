                    ...
                    <div className='my-6'>
                        <Link href="/kidsrides">
                            <button className='flex items-center btn text-white px-8 py-2'>
                                Know More <span className='bg-white rounded-[50%] w-10 h-10 ml-5 flex items-center justify-center '><Image src="/arrow.svg" priority height={18} width={18} alt="abc" /></span>
                            </button>
                        </Link>
