import ParkAttractions1 from "@/public/Home/parkAttractions/parkAttractions1.svg"
import ParkAttractions2 from "@/public/Home/parkAttractions/parkAttractions2.svg"
import ParkAttractions3 from "@/public/Home/parkAttractions/parkAttractions3.svg"
import ParkAttractions4 from "@/public/Home/parkAttractions/parkAttractions4.svg"
import ParkAttractions5 from "@/public/Home/parkAttractions/parkAttractions5.svg"
import ProceedBtn from "../Repeating/Button"
import FreeFall from "@/public/Home/parkAttractions/freeFall.svg"
    ...
    return (
        <div className='flex flex-col items-center px-[3vw] gap-6 relative mb-16'>
            ...
            <animated.div className='flex flex-wrap gap-4 justify-center mt-4' ref={divRef} style={divProps} >
                <div className='min-w-[270px] bg-cover bg-center max-w-[400px] h-[500px] bg-[url("../public/Home/parkAttractions/newimage2.png")] 
                '>
                ...
                <div className='min-w-[270px] max-w-[400px] bg-cover bg-center h-[500px] bg-[url("../public/Home/parkAttractions/newimage8.png")]'>
                    <div className="overlay w-full h-full flex flex-col items-center justify-end ">
                        <div className='text-white px-6 py-6 overlay-text'>
                            <div className="w-full">
