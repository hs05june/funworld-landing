        ...
        <div className='w-screen'>
            ...
            >
                ...
                <div className='w-full  flex flex-col items-center text-center justify-center xl:min-h-[125vh] lg:min-h-[90vh] md:h-[75vh] h-[60vh] md:gap-8 gap-4'>
                    ...
                    <p className='lg:px-32 md:px-16 px-4 md:text-[20px]  lg:leading-[32px] liquid'>At our amusement park in Bengaluru, your safety is our top priority. We follow strict safety guidelines, conduct regular inspections, and have trained staff for both water & non-water rides to ensure you have a blast with peace of mind!</p>
                    <Link href={'/amusementpark'}><button className="rounded-full md:text-[21px] px-3 py-2  shadow-md md:px-6 md:py-3 text-white font-[500] flex gap-4 items-center  text-center  justify-center btn2 " >
            ...
            <div className={`lg:clip-path-ticket bg-[#EBF0FE] min-h-[80vh] relative top-[-150px] lg:pt-[230px] pt-[70px] px-[10vw] pb-24`}>
                ...
                >
                    <h2 className='xl:text-[62px] xl:leading-[68px] lg:text-[45px] lg:leading-[47px] md:text-[32px] md:leading-[34px] text-[24px] leading-[24px] text-[#0B1A48] mb-6 font-[620] text-center'>Splash, Spin, Soar: Your Ultimate<br /> Family Escape Awaits!</h2>
                    ...
                    <div className='lg:block hidden'>
                        <div className={`flex lg:flex-row flex-col  lg:items-center justify-around xl:gap-4 lg:gap-2 gap-4 xl:text-[23px] xl:leading-[25px] lg:text-[19px] md:text-[17px] text-[15px] font-[620] text-[#2A324A]`}>
                            ...
                            <button className={`flex px-6 py-3 rounded-3xl lg:w-auto w-[90vw] ${comp === 5 && ' text-white font-[500] bg-gradient-to-br   from-[#FFCC00] to-[#FD1783]'}`} onClick={() => { handleCompChange(5) }}>Family Rides</button>
                        </div>
                        <div className='mt-8'>
                            {
                                comp === 1 ? (
                                    ...
                                    <div className='flex fade-in active'>
                                        ...
                                        <div className='flex-1 lg:ml-12 lg:items-start items-center lg:text-start text-center flex flex-col xl:gap-8 gap-4' >
                                            ...
                                            <p className='text-justify xl:text-[20px] xl:leading-[33px] text-[#5B5B5B]'> Gather your loved ones and share moments of laughter and bonding on these incredible attractions. Get ready for a day filled with endless fun and cherished memories!
                                            </p>
                                            <Link href='/landrides' >
                                                <ProceedBtn text="Know More" />
                                            </Link>
                                    ...
                                    <div className='flex fade-in active'>
                                        ...
                                        <div className='flex-1 lg:ml-12 lg:items-start items-center lg:text-start text-center flex flex-col xl:gap-8 gap-4' >
                                            ...
                                            <p className='text-justify xl:text-[20px] xl:leading-[33px] text-[#5B5B5B]'>Parents can join the fun or watch proudly from the sidelines as their kids create cherished memories on our specially curated rides. Safety is our top priority, ensuring worry-free enjoyment for the whole family.
                                            </p>
                                            <Link href='/kidsrides' >
                                                <ProceedBtn text="Know More" />
                                            </Link>
                                    ...
                                    <div className='flex fade-in active'>
                                        ...
                                        <div className='flex-1 lg:ml-12 lg:items-start items-center lg:text-start text-center flex flex-col xl:gap-8 gap-4' >
                                            ...
                                            <p className='text-justify xl:text-[20px] xl:leading-[33px] text-[#5B5B5B]'>Family rides in the amusement park and water park provide youngsters with the chance to explore alongside their loved ones. So gather your family and embark on a day full of laughter and bonding!
                                            </p>
                            ...
                            <SplideSlide>
                                <div className='flex'>
                                    <div className='flex-1 lg:ml-12 lg:items-start items-center lg:text-start text-center flex flex-col xl:gap-8 gap-4 px-6' >
                                        ...
                                        <p className='text-justify xl:text-[20px] xl:leading-[33px] text-[#5B5B5B]'>
                                            Discover a world of excitement and joy on our thrilling land rides at the amusement park. From the classic carousel to the heart-pounding roller coasters, there&apos;s something for everyone. Riders of all ages can experience delightful adventures as they twist, turn, and soar through the air.
                                        <br/>Gather your loved ones and share moments of laughter and bonding on these incredible attractions. Get ready for a day filled with endless fun and cherished memories!
                                        </p>
                                        <Link href='/landrides' >
                                            <ProceedBtn text="Know More" />
                                        </Link>
