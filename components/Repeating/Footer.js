...
const Footer = () => {
  ...
  return (
    <div className="relative overflow-hidden mt-10 ">
      <img
        priority
        className="absolute lg:block hidden md:left-4 z-30 rotate-6 md:bottom-[240px] bottom-[600px]"
        src={"https://funworldblr.s3.amazonaws.com/public/Reusable/wires.webp"}
        alt="wires"
      />
      ...
      <div className='min-h-[400px] relative overflow-hidden lg:mt-12 text-white sm:py-8 lg:4 bg-[#1F1F34] bg-[url("https://funworldblr.s3.amazonaws.com/public/Home/footer/footerBG.webp")] flex flex-row flex-wrap  items-start xl:gap-8 lg:gap-6 gap-x-4 gap-y-8 md:pl-[10vw] md:justify-between justify-around md:pr-[5vw] md:pt-20 pb-12 '>
        <div className="lg:w-[25vw] w-[100vw]">
          <div className="flex relative top-[-50px] flex-col items-center gap-4 my-8 pt-10">
            <img
              src={
                "https://funworldblr.s3.amazonaws.com/public/Home/footer/LogoBnG.svg"
              }
              priority
              alt="logo"
            />
            <div className="w-full flex gap-4 flex-col">
              <div className="flex gap-3 items-center ml-12 lg:ml-0">
                <div>
                  <img
                    priority
                    src={
                      "https://funworldblr.s3.amazonaws.com/public/Reusable/foter-call.webp"
                    }
                    alt="calling icon"
                  />
                </div>
                <div
                  ...
                  title="Click to Copy"
                >
                  <p className="hover:text-[#FFBF0A] hover:scale-105 transition-all delay-200 md:text-base">
                    084311 10000
                  </p>
              ...
              <div className="flex gap-3 items-center text-[12px] ml-12 lg:ml-0">
                <img
                  priority
                  src={
                    "https://funworldblr.s3.amazonaws.com/public/Reusable/footer-email.webp"
                  }
                  alt="Email icon"
                />

                <Link href={"mailto:info@funworldblr.com"}>
                  <p className="hover:text-[#FFBF0A] hover:scale-105 transition-all delay-200 cursor-pointer md:text-base">
                    {" "}
                    info@funworldblr.com
                  </p>
                </Link>
              </div>
              <Link
                href={
                  "https://www.google.co.in/maps/dir//Fun+World+Amusement+Park,+Palace+Grounds,+Jayamahal+Main+Rd,+opposite+TV+Tower,+J.C.Nagar,+Bengaluru,+Karnataka+560006/@13.0069448,77.5895227,17z/data=!4m8!4m7!1m0!1m5!1m1!1s0x3bae17b55c78182f:0xd46d15155f682466!2m2!1d77.5920976!2d13.0069448?entry=ttu"
                }
              >
                <div className="flex gap-2 items-center text-center text-[12px] lg:px-0  px-12">
                  <img
                    priority
                    src={
                      "https://funworldblr.s3.amazonaws.com/public/Reusable/footer-address.webp"
                    }
                    alt="Address icon"
                  />
                  <p className="hover:text-[#FFBF0A] hover:scale-105 transition-all delay-200 md:text-base text-left">
                    Palace Grounds, Jayamahal Main Rd, Opposite TV Tower,
                    J.C.Nagar Bengaluru, Karnataka 560006
                  </p>
                </div>
              </Link>
            </div>
        ...
        <div className="flex flex-col md:gap-6 gap-2 px-6">
          ...
          <ul className="flex flex-col md:gap-4 gap-1 list-disc	text-[11px]">
            <li className="hover:text-[#FFBF0A] hover:scale-105 transition-all delay-200 md:text-base">
              <Link href="/directions">Park Directions</Link>
            </li>

            <li className="hover:text-[#FFBF0A] hover:scale-105 transition-all delay-200 md:text-base">
              <Link href={`/guidelines/policy`}>Policy</Link>
            </li>
            ...
            <li className="hover:text-[#FFBF0A] hover:scale-105 transition-all delay-200 md:text-base">
              <Link href={`/safetymeasures`}>Covid19 Safety</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col md:gap-6 gap-2 px-6">
          ...
          <ul className="flex flex-col md:gap-4 gap-1 list-disc	text-[11px]">
            <li className="hover:text-[#FFBF0A] hover:scale-105 transition-all delay-200 md:text-base">
              <Link href="/rides&attractions">Rides & Attractions</Link>
            </li>

            <li className="hover:text-[#FFBF0A] hover:scale-105 transition-all delay-200 md:text-base">
              <Link href="/facilities">Facilities at the Park</Link>
            </li>
            <li className="hover:text-[#FFBF0A] hover:scale-105 transition-all delay-200 md:text-base">
              <Link href="/park-prohibitions">Park Prohibitions</Link>
            </li>
        ...
        <div className="flex flex-col md:gap-6 gap-2 px-2 ">
          ...
          <ul className="flex flex-col md:gap-4 gap-1 list-disc text-[11px]">
            <li className="hover:text-[#FFBF0A] hover:scale-105 transition-all delay-200 md:text-base">
              <Link href="/guidelines/codeofsafety">Code of Safety</Link>
            </li>

            <li className="hover:text-[#FFBF0A] hover:scale-105 transition-all delay-200 md:text-base">
              <Link href="/guidelines/codeofconduct">Code of Conduct</Link>
            </li>

            <li className="hover:text-[#FFBF0A] hover:scale-105 transition-all delay-200 md:text-base">
              <Link href="/guidelines/rules">Rules & Regulations</Link>
            </li>

            <li className="hover:text-[#FFBF0A] hover:scale-105 transition-all delay-200 md:text-base">
              <Link href="/guidelines/disclaimer">Disclaimer</Link>
            </li>
          </ul>
        </div>
      ...
      <div className="bg-[#33344E] text-white md:py-3 md:text-[14px] text-[10px] flex justify-around py-3">
        ...
        <div>Copyright @2023 funworld pvt ltd</div>
      </div>
    </div>
  );
};
