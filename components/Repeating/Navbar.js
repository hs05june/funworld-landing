          ...
          <div className='flex flex-row relative justify-between w-full'>
            ...
            <div className='flex xl:gap-8 lg:gap-4 gap-3 items-center  text-[19px] font-[600]'>
              <Link href='/' className='flex flex-col group'>
                <span>EXPLORE</span>
                <span className='w-0 group-hover:w-[100%] transition-all duration-200 h-[3px] bg-[#B6004C]'></span>
              </Link>
              ...
              <div className='flex flex-col group'>
                ...
                >
                  ...
                  >
                    ...
                    <motion.li variants={itemVariants}><Link href="/service">SERVICES</Link></motion.li>
                  </motion.ul>
                </motion.nav>
              </div>
      ...
      <div className='lg:hidden block'>
        <div className='flex flex-col items-end justify-around mx-5 h-20'>
          ...
          <div className='flex flex-row gap-5 items-center'>
            ...
            <div onClick={()=>setIsNavOpen(true)} className='cursor-pointer z-1'>
...
<button className="absolute right-0 p-5" onClick={()=>setIsNavOpen(false)}>
        {/* Close icon */}
          ...
          <div className={`flex flex-col gap-5 z-50`}>
            <Link href="/" className='flex flex-col group'>
              <span className={`${pathname === '/' ? 'text-[#B6004C]' : ''}`} onClick={() => setIsNavOpen(false)}>EXPLORE</span>
              <span className={`w-0 group-hover:w-[100%]  transition-all duration-200 h-[3px] bg-[#B6004C] ${pathname === '/' ? 'w-[100%] ' : ''}`}></span>
            </Link>

            <Link href="/amusementpark" className='flex flex-col group'>
              <span className={`${pathname === '/amusementpark' ? 'text-[#B6004C]' : ''}`} onClick={() => setIsNavOpen(false)}>AMUSEMENT PARK</span>
              <span className={`w-0 group-hover:w-[100%]  transition-all duration-200 h-[3px] bg-[#B6004C] ${pathname === '/amusementpark' ? 'w-[100%] ' : ''}`}></span>
            </Link>

            <Link href="/waterpark" className='flex flex-col group'>
              <span className={`${pathname === '/waterpark' ? 'text-[#B6004C]' : ''}`} onClick={() => setIsNavOpen(false)}>WATER PARK</span>
              <span className={`w-0 group-hover:w-[100%]  transition-all duration-200 h-[3px] bg-[#B6004C] ${pathname === '/waterpark' ? 'w-[100%] ' : ''}`}></span>
            </Link>

            <Link href="/about" className='flex flex-col group'>
              <span className={`${pathname === '/about' ? 'text-[#B6004C]' : ''}`} onClick={() => setIsNavOpen(false)}>ABOUT US</span>
              <span className={`w-0 group-hover:w-[100%]  transition-all duration-200 h-[3px] bg-[#B6004C] ${pathname === '/about' ? 'w-[100%] ' : ''}`}></span>
            </Link>

            <Link href="/service" className='flex flex-col group'>
              <span className={`${pathname === '/service' ? 'text-[#B6004C]' : ''}`} onClick={() => setIsNavOpen(false)}>SERVICES</span>
              <span className={`w-0 group-hover:w-[100%]  transition-all duration-200 h-[3px] bg-[#B6004C] ${pathname === '/service' ? 'w-[100%] ' : ''}`}></span>
            </Link>
